...
class GraphModifier:
    ...
    def __init__(self, name):
        ...
        self._pendingModifications = queue()
    ...
    def create_recommendation_link(self, node1DatabaseID, node2DatabaseID, weight=1.0):
        ...
        self._push_modification(NewRecommendationLink(n1=node1DatabaseID, n2=node2DatabaseID, weight=weight))
    ...
    def remove_post(self, databaseID):
        ...
        self._push_modification(PostRemoval(databaseID=databaseID))
    ...
    def delete_post(self, databaseID):
        ...
        self._push_modification(PostDeletion(databaseID=databaseID))
    ...
    def modifyPost(self, databaseID, newSize):
        ...
        self._push_modification(PostModification(databaseID=databaseID, newSize=newSize))
