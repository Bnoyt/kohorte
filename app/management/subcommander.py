# -*- coding: utf-8 -*-
#source: https://gist.github.com/bruth/6121877
import sys
...
class Subcommander(BaseCommand):
    ...
    import_template = '{app_name}.management.commands.{folder}.{module_name}'
    ...
    def get_subcommand(self, subcommand):
        try:
            module = import_module(self.import_template.format(app_name=self.app_name,
                module_name=self.subcommands[subcommand], folder=self.folder))
